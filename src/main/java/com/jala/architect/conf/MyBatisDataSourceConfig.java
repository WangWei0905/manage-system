 ...
 */
package com.jala.architect.conf;

import com.alibaba.druid.pool.DruidDataSource;
import com.jala.architect.properties.AppCommonMyBatisProperties;
import com.jala.architect.properties.JdbcProperties;
...
@EnableTransactionManagement
 //扫描 Mapper 接口并容器管理
@MapperScan(basePackages = "com.jala.dao")
